...
export function canonicalize(obj) {
    ...
    // DEBUG: log cleaned object before stringify
    // (Temporary, will be removed after inspection)
    try {
        // Avoid logging huge objects in production; this is a single-iteration debug
        // eslint-disable-next-line no-console
        console.log('[CANONICALIZE DEBUG] cleaned object:', JSON.stringify(sorted));
    }
    catch (e) {
