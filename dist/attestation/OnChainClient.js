 ...
 */
import { PHASE5_FEATURES, isAttestationEnabled } from '../config/Phase5Flags.js';
/**
 ...
 */
function isNetworkAllowed(network) {
 ...
 */
export async function submitAttestationOnChain(request) {
 ...
 */
export async function pollAttestationStatus(transactionHash) {
 ...
 */
export async function verifyAttestationOnChain(attestationId) {
    // Safety check: Feature must be enabled
    if (!isAttestationEnabled()) {
        return false;
    }
 ...
 */
export function getAttestationContract() {
    const network = PHASE5_FEATURES.ATTESTATION_NETWORK;
...
//# sourceMappingURL=OnChainClient.js.map