...
import { BillingResult } from '../src/billing';

// Test utilities
const TEST_LEDGER_DIR = path.join('/tmp', '.openclaw', 'revenue-test');

function createTestBillingResult(sessionId: string, totalDue: number): BillingResult {
  return {
...
function testAppendOnlyInvariant(): boolean {
  cleanupTestLedger();
...
function testIdempotency(): boolean {
  cleanupTestLedger();
...
function testDailyRollups(): boolean {
  cleanupTestLedger();
...
function testAgentSummary(): boolean {
  cleanupTestLedger();
...
function testLedgerEntryStructure(): boolean {
  cleanupTestLedger();
...
function testEmptyLedger(): boolean {
  cleanupTestLedger();
...
function testSettlementModes(): boolean {
  cleanupTestLedger();
...
function testDashboardAggregation(): boolean {
  cleanupTestLedger();
...
// Run all tests
export function runRevenueLedgerTests(): void {
  console.log('\n╔════════════════════════════════════════════════════════════╗');
